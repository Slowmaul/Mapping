...
Each of these "Tenant" branches will consist of this readme.txt file, a folder
with the cleaned name.  This folder will contain any XBSP deployed for this tenant
...
The purpose of the folder structure in each branch is to isloate maps by tenant incase
2 or more branches are accidentally merged together.  
